        ...
        <div class="row">
            <div class="col pr-8">
                <div class="card card-dasboard text-white bg-info mb-3">
                    ...
                    <div class="card-body card-body-dasboard">
                        <h5 class="card-title card-title-dasboard text-center individual-number">{{ $qty_remain }}</h5>
            ...
            <div class="col pl-8 pr-8">
                <div class="card card-dasboard text-white bg-warning mb-3">
                    ...
                    <div class="card-body card-body-dasboard">
                        <h5 class="card-title card-title-dasboard text-center"><a href=" {{ url("/admin/product/sales") }}" title="Xem chi tiết doanh số">{!! number_format($total_product_sales) !!}</a></h5>
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Tổng số lượng SP</th>
                            ...
                            @foreach ($orders as $order)
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('admin.order.detail', $order->id) }}"
                                            ...
                                            data-toggle="tooltip" data-placement="top" title="Chi tiết đơn hàng">Các sản
                                            phẩm của đơn hàng</a>
                                    </td>
                                    <td>{{ $order_total }}</td>
