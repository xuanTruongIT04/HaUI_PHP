...
class AdminCustomerController extends Controller
{
    ...
    function list(Request $requests) {
        ...
        if ($status == "trashed") {
            ...
            $customers = Customer::onlyTrashed()->where("customer_name", "LIKE", "%{$key_word}%")->Paginate(20);
        } else {
            $customers = Customer::withoutTrashed()->where("customer_name", "LIKE", "%{$key_word}%")->Paginate(20);
        }
